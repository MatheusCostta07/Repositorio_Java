...
public class TelaImg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(460, 550, 360, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaImg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
